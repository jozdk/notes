...
export const Layout = ({ notelist, searchTerm }) => {
    ...
    return (
        <div className="flex">
            <div style={{ width: `${displaySidebar ? "320px" : "0"}`, left: `${displaySidebar ? "0px" : "-50px"}` }} className="fixed z-10 overflow-x-hidden bg-gray-50 h-[calc(100vh_-_72px)] hover:overflow-y-scroll md:shadow-none shadow-sidebar md:pl-12 pl-3 md:pt-6">
